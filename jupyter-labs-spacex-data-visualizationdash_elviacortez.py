...
#  1. ¿Qué sitio tiene los lanzamientos más exitosos?
#  ksc lc-39a

# 2. ¿Qué sitio tiene la mayor tasa de éxito de lanzamiento?
# ksc lc-39a
#  3. ¿Qué rango(s) de carga útil tiene la mayor tasa de éxito en el lanzamiento?
#entre 2 y 4 kilos
 
# 4. ¿Qué rango(s) de carga útil tiene la tasa de éxito de lanzamiento más baja?
#entre 6 y 8 k
#  5. ¿Qué versión de F9 Booster (v1.0, v1.1, FT, B4, B5, etc.) tiene la mayor
